...
class AzureContentUnderstandingClient:
    def __init__(
        self,
        endpoint: str = "https://hayan-test-02.services.ai.azure.com/",
        api_version: str = "2024-12-01-preview",
        subscription_key: str = "CIJEScgcJxWdSHTV4Vhn42giQKiifkAHUEE2GqBguuqPNxm0lWCKJQQJ99AKACfhMk5XJ3w3AAAAACOGfvgx",
